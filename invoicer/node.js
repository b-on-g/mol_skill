...
;
	($.$bog_mol_invoicer) = class $bog_mol_invoicer extends ($.$mol_page) {
		...
		Source_upload(){
			...
			(obj.accept) = () => ("application/pdf,text/plain");
			(obj.multiple) = () => (false);
		...
		Signature_upload(){
			...
			(obj.accept) = () => ("image/*");
			(obj.multiple) = () => (false);
			(obj.files) = (next) => ((this.signature_files(next)));
			return obj;
		}
		signature_uri(next){
			if(next !== undefined) return next;
		...
		Signature_preview(){
			...
			(obj.uri) = () => ((this.signature_uri()));
			return obj;
		}
		Signature_section(){
			const obj = new this.$.$mol_list();
			(obj.rows) = () => ([
				(this.Signature_label()), 
				(this.Signature_upload()), 
				(this.Signature_preview())
			]);
			return obj;
		}
		communication(){
		...
		Download_pdf(){
			...
			(obj.blob) = () => ((this.result_pdf_blob()));
			(obj.file_name) = () => ((this.result_pdf_name()));
		...
		foot(){
			return [(this.Download_pdf()), (this.Download_doc())];
		}
	};
	...
	($mol_mem(($.$bog_mol_invoicer.prototype), "signature_files"));
	($mol_mem(($.$bog_mol_invoicer.prototype), "Signature_upload"));
	($mol_mem(($.$bog_mol_invoicer.prototype), "signature_uri"));
	($mol_mem(($.$bog_mol_invoicer.prototype), "Signature_preview"));
...
${signature_html}
        ...
        __decorate([
            $mol_mem
        ], $bog_mol_invoicer.prototype, "signature_files", null);
        __decorate([
            $mol_mem
        ], $bog_mol_invoicer.prototype, "result_pdf_blob", null);
        __decorate([
            $mol_mem
        ], $bog_mol_invoicer.prototype, "result_doc_blob", null);
        $$.$bog_mol_invoicer = $bog_mol_invoicer;
        class $bog_mol_invoicer_file {
            static read_text(file) {
